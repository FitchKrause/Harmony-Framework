/// @description Draw the HUD
	...
	//Draw normal text
	draw_sprite(spr_hudtext, 0, 16 + offset[0], 9);
	draw_sprite(spr_hudtext, 1, 16 + offset[1], 25);
	draw_sprite(spr_hudtext, 2, 16 + offset[2], 41);
	
	//Red flashing text
	if(global.stage_timer >= 540000 && global.object_timer mod 20 < 20/2) draw_sprite(spr_hudtext, 3, 16 + offset[1], 25);
	if(global.rings == 0 && global.object_timer mod 20 < 20/2) draw_sprite(spr_hudtext, 4, 16 + offset[2], 41);
	
	//Draw life icon
	draw_sprite(spr_hud_life, global.character, 16 + offset[3], global.window_height - 24);
	...
	draw_text(87 + offset[2], 41, string(global.rings));
	
	
	draw_set_font(global.hud_life_number);
	draw_set_halign(fa_right);
	draw_text(48 + (offset[3]), global.window_height - 16, (global.life > 9 ? "" : "0") + string(global.life));
